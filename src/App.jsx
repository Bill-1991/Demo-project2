    ...
    async function fetchData() {
      try {
        const res = await fetch(
          "https://companies-co8z.onrender.com/companies",
        );
            ...
            <Route
              ...
              element={
                <Company
                  ...
                  handleChangeItemRoute={handleChangeItemRoute}
                  handleSaveFile={handleSaveFile}
                  company={company}
                  searchItems={searchItems}
                  chosenItems={chosenItems}
                  handleChosenItems={handleChosenItems}
                  order={order}
                  handleOrder={handleOrder}
                  tableNum={tableNum}
                  handleCurTable={handleCurTable}
                  handleDecreaseItems={handleDecreaseItems}
